...
--
-- Name: gorgonzola; Type: SCHEMA; Schema: -; Owner: ci
--

CREATE SCHEMA gorgonzola;


ALTER SCHEMA gorgonzola OWNER TO ci;
...
--
-- Name: user; Type: TABLE; Schema: gorgonzola; Owner: ci
--

CREATE TABLE gorgonzola."user" (
    id integer,
...
ALTER TABLE gorgonzola."user" OWNER TO ci;
...
--
-- Data for Name: user; Type: TABLE DATA; Schema: gorgonzola; Owner: ci
--

COPY gorgonzola."user" (id, org, rate) FROM stdin;
5	apple	4
7	ms	5
9	blackberry	7
\.
